...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain() {
    ...
    mFeedForward = new SimpleMotorFeedforward(Constants.DriveConstants.DRIVETRAIN_kS, Constants.DriveConstants.DRIVETRAIN_kV, Constants.DriveConstants.DRIVETRAIN_kA);
    ...
    mSimulation = new MecanumSimulation(
      ...
      Constants.DriveConstants.DRIVETRAIN_CHARACTERIZATION,
      mKinematics,
